              ...
              <>
                ...
                {registrationType === 'TEACHER' && (
                  <>
                    ...
                    {/* Subjects Section - FIXED: Simple list without grouping by class */}
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                        Subjects Teaching *
                      </label>
                      <div className="max-h-64 overflow-y-auto border border-gray-200 rounded-lg p-3 space-y-2 bg-white">
                        {subjects.length > 0 ? (
                          subjects.map((subject) => (
                            ...
                            >
                              ...
                              <span className="text-sm text-gray-700">
                                {subject.name}
                                {subject.code && <span className="text-xs text-gray-400 ml-2">({subject.code})</span>}
                              </span>
                            </label>
                          ))
                        ) : (
