...
export default ReportCard;import { useState, useMemo, useEffect } from "react";
import { useQuery } from "@tanstack/react-query";
import { useAuth } from "../context/AuthContext";
import { useTerm } from "../context/TermContext";
import { dashboardService } from "../services/dashboard.service";
...
export const ReportCard = () => {
  ...
  // Fetch teacher comments when student or term changes
  useEffect(() => {
    ...
    <div className="space-y-6 print:space-y-2">
      ...
      {gradesLoading ? (
        ...
        <div className="bg-white rounded-lg shadow-lg print:shadow-none overflow-hidden">
          ...
          {/* Cumulative Summary with Teacher Comments */}
          <div className="p-6 border-t bg-gray-50 print:p-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                <p className="text-sm text-gray-500">Cumulative Average</p>
              ...
              <div className="col-span-2">
                ...
                {/* Display saved teacher comments */}
